...
(function($) {
  ...
  ContentTemplating = function(api, spi) {
    var components, createComponentEditor, setComponent, setConfigElementValue;
    components = {};
    setComponent = function(component, type, config) {
      return component.data('component-config', config).attr('data-role', 'component').attr('data-component-type', type);
    };
    ...
    createComponentEditor = function(name, config) {
      ...
      return setComponent(editor, name, config);
    };
    return {
      extensionPoints: function() {
