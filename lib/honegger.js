  ...
  ContentComponent = function(api, spi) {
    ...
    return {
      extensionPoints: function() {
        ...
        spi.toComponent = function(target) {
          return createComponent(function() {
            return $('*[data-role="component"]', target);
      ...
      extensions: function() {
        ...
        return spi.mode('preview', {
          on: function() {
            return spi.toComponent(spi.composer);
          },
          off: function() {
...
(function($) {
  ...
  $.fn.honegger.page = function(options) {
    ...
    return {
      dataTempalte: {},
      editor: function(template, config, component) {
        var editor;
        editor = component != null ? component : $(options.template);
        if ($('.add-layout', editor).length !== 0) {
          return editor;
        }
      ...
      control: function(template, config, component) {
        if (component == null) {
          return $('<div></div>');
        }
