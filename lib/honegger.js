...
(function($) {
  ...
  ComponentEditor = (function() {
    ...
    return {
      ...
      create: function(target, component, config, value) {
        var editor;
        if (value == null) {
  ...
  ContentComponent = function(api, spi) {
    ...
    createComponentEditor = function(target, name, id, config, value) {
      return newComponent(ComponentEditor.create(target, components[name], config, value), id, name, config);
    };
  ...
  ContentTemplate = function(api, spi) {
    return {
      extensionPoints: function() {
        ...
        return api.loadContentTemplate = function(template, config, content) {
          spi.composer.html(template);
          $.each(config, function(key, value) {
            return $("[data-component-id='" + key + "']", spi.composer).data('component-config', value);
          });
          return $.each(content, function(key, value) {
