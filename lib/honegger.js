...
(function($) {
  ...
  ComponentEditor = (function() {
    ...
    return {
      ...
      setConfiguration: function(editor, value) {
        return setValues(editor, value, 'data-component-config-key');
      },
    ...
    return {
      extensionPoints: function() {
        ...
        spi.toControl = function(target) {
          return createComponent(function() {
            return $('*[data-role="component"][data-component-type!="page"]', target);
        ...
        api.insertComponent = function(name, config, content) {
          if (config == null) {
            config = {};
          }
          return spi.insertComponent(spi.composer, name, config, content);
        };
        api.getComponentConfiguration = function(component) {
          return ComponentEditor.getConfiguration(component);
        };
        return api.setComponentConfiguration = function(component, value) {
          return ComponentEditor.setConfiguration(component, value);
        };
      },
      extensions: function() {
        spi.mode('edit', {
