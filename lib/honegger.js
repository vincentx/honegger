...
(function($) {
  ...
  ContentTemplating = function(api, spi) {
    var IdGenerator, components, createComponentControl, createComponentEditor, newComponent, setConfigElementValue;
    components = {};
    ...
    createComponentEditor = function(name, id, config) {
      ...
      return newComponent(editor, id, name, config);
    };
        ...
        spi.mode('edit', {
          on: function(composer) {
            return $('*[data-role="component"]', composer).each(function() {
              var component;
              component = $(this);
              return component.replaceWith(createComponentEditor(component.data('component-type'), component.data('component-id'), component.data('component-config')));
            });
          },
        ...
        return spi.mode('preview', {
          on: function(composer) {
            return $('*[data-role="component"]', composer).each(function() {
              var component;
              component = $(this);
              return component.replaceWith(createComponentControl(component.data('component-type'), component.data('component-id'), component.data('component-config'), {}));
            });
          },
          off: function(composer) {}
        });
