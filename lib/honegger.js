...
(function($) {
  var ComponentEditor, ContentTemplating;
  ComponentEditor = (function() {
    var getConfigElementValue, setConfigElementValue, setupNestedStructure;
    ...
    setupNestedStructure = function(config, key) {
  ...
  ContentTemplating = function(api, spi) {
    ...
    createComponent = function(composer, creator) {
      return $('*[data-role="component"]', composer).each(function() {
        var component;
        component = $(this);
    ...
    destroyComponent = function(composer, destroy) {
      return $('*[data-role="component"]', composer).each(function() {
        var component, type;
        component = $(this);
      ...
      extensions: function() {
        spi.mode('edit', {
          on: function(composer) {
            return createComponent(composer, createComponentEditor);
          },
          off: function(composer) {
            return destroyComponent(composer, 'destroyEditor');
          }
        });
        return spi.mode('preview', {
          on: function(composer) {
            return createComponent(composer, createComponentControl);
          },
          off: function(composer) {
            return destroyComponent(composer, 'destroyControl');
          }
        });
      }
    };
