(function($, document, window) {
  ...
  Honegger = function(element, options) {
    var bindHotkey, changeMode, componentIds, components, composer, currentRange, disable, disabled, editMode, enable, execCommand, generateId, getConfiguration, init, insideComposer, makeComposer, makeComposers, mode, notInsideComponent, previewMode, self, toolbar;
    self = this;
    composer = $(element);
    components = {};
    disabled = false;
