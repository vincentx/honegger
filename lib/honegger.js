(function($, document, window) {
  ...
  Honegger = function(element, options) {
    var bindHotkey, composer, currentRange, execCommand, makeComposer, makeComposers, toolbar;
    composer = $(element);
    ...
    makeComposer = function(element) {
      ...
      element.attr('contenteditable', 'true').on('mouseup keyup mouseout focus', function() {
        return $.fn.honegger.toolbar(toolbar, currentRange, options);
      });
  ...
  $.fn.honegger.toolbar = function(toolbar, currentRange, options) {
