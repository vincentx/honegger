(function($, document, window) {
  ...
  Honegger = function(element, options) {
    var bindHotkey, changeMode, composer, currentRange, disable, disabled, enable, execCommand, getConfiguration, init, insideComposer, installed, makeComposer, makeComposers, mode, notInsideComponent, self, toolbar;
    self = this;
  ...
  $.fn.honegger.components = function(composer, options) {
    var changeMode, componentIds, components, generateId, getConfiguration;
    components = {};
    componentIds = {};
