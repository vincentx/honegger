(function($, document, window) {
  ...
  Honegger = function(element, options) {
    var bindHotkey, components, composer, currentRange, disabled, enable, execCommand, init, insideComposer, makeComposer, makeComposers, notInsideComponent, self, toolbar;
    self = this;
    disabled = false;
    ...
    this.getTemplate = function(handler) {
      ...
      return components.getTemplate(template, function(dataTemplate, configurations) {
...
(function($) {
  return $.fn.honegger.components = function(composer, options) {
    var changeMode, componentIds, components, config, generateId, getConfiguration, setConfiguration;
    components = {};
    componentIds = {};
    ...
    changeMode = function(element, handler) {
      ...
      return element.replaceWith(config(handler(components[element.data('component-type')], configuration), element.data('component-id'), element.data('component-type'), config));
    };
    return {
      ...
      newComponent: function(name) {
        return config(components[name].editor(options.componentEditorTemplate, {}), generateId(name), name, {});
      },
      modes: {
