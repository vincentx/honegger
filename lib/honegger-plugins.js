(function($) {
  ...
  return $.fn.honegger.defaults.plugins.push(Page);
})(jQuery);

(function($) {
  var Theme;
  Theme = function(api, spi) {
    var initEvents;
    initEvents = function() {
  ...
  return $.fn.honegger.defaults.plugins.push(Theme);
})(jQuery);

(function($) {
  var PageList;
  PageList = function(api, spi) {
  ...
  return $.fn.honegger.defaults.plugins.push(PageList);
})(jQuery);
